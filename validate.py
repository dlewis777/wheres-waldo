...
#waldo_dataset = datasets.ImageFolder(root='data/256', transform=data_transform)
...
image_datasets = {x: datasets.ImageFolder(os.path.join(data_dir, x),
                                          data_transforms[x])
                  for x in ['heldout']}
image_datasets = datasets.ImageFolder(os.path.
...
#device = torch.device("cpu") # for cuda error
